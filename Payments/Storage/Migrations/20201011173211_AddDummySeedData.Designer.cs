...
namespace Payments.Storage.Migrations
{
    ...
    [Migration("20201011173211_AddDummySeedData")]
    partial class AddDummySeedData
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Payments.MerchantAggregate.Merchant", b =>
                {
            ...
            modelBuilder.Entity("Payments.MerchantAggregate.Merchant", b =>
                {
                    b.OwnsOne("Payments.SharedValueTypes.CreditCardInfo", "CreditCardInfo", b1 =>
                        {
                            ...
                            b1.OwnsOne("Payments.SharedValueTypes.ExpiryDate", "ExpiryDate", b2 =>
                                {
            ...
            modelBuilder.Entity("Payments.Payment", b =>
                {
                    b.OwnsOne("Payments.PaymentAmount", "Amount", b1 =>
                        {
